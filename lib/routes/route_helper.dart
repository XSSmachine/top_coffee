...
class RouteHelper{
  ...
  static String getEventDetail(String eventId, String page,String? orderId)=>'$eventDetail?eventId=$eventId&page=$page&orderId=$orderId';
  static String getAccountPage()=>'$accountPage';
  static String getOrderPage()=>'$orderPage';
  static String getAllOrderPage()=>'$allOrderPage';
  static String getCreateOrderPage()=>'$createOrderPage';
  ...
  static List<GetPage> routes= [
    ...
    GetPage(name: createOrderPage, page: ()=>CoolTextFieldScreen()),
    GetPage(name: allOrderPage, page: ()=>AllOrdersScreen()),
    GetPage(name: "/", page: ()=> HomePage()),
    GetPage(name: eventCreatePage, page: ()=>CreateEventPage()),
    GetPage(name: eventDetail, page: (){
      var eventId = Get.parameters['eventId'];
      var orderId = Get.parameters['orderId'];
      var page = Get.parameters["page"];
      return EventDetailsScreen(eventId: eventId!,page:page!,orderId: orderId,);}),
  /*
