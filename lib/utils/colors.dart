...
class AppColors{
  ...
  static final Color mainColor = const Color(0xFFB8B7BD);
  //static final Color mainColor = const Color(0xFFfa7552);
  static final Color iconColor1 = const Color(0xFF283747);
  static final Color iconColor2 = const Color(0xFF5D6D7E);
  ...
  static final Color yellowColor = const Color(0xFFFFC300);
